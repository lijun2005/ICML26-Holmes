...
class Holmes_Net(nn.Module):
    ...
    def forward(self, batch):
        ...
        clip_scale_scores, clip_scale_scores_, frame_scale_scores, frame_scale_scores_ \
            ...
            query_feat, query_mask, query_labels, vid_proposal_feat, encoded_frame_feat,frame_video_mask, return_query_feats=True)
    ...
    def get_pred_from_raw_query(self, query_feat, query_mask, query_labels=None,
                                video_proposal_feat=None, encoded_frame_feat=None,video_mask=None,
