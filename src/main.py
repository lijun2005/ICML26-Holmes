...
parser.add_argument(
    '-d', '--dataset_name', default='cha', type=str, metavar='DATASET', help='dataset name', 
    choices=['tvr', 'act', 'cha']
)
parser.add_argument(
...
# parser.add_argument('--resume', default='/data2/lianniu/prvr_model_cv/charades/gmmformer_v2/best.ckpt', type=str)
parser.add_argument('--resume', default='',type=str)
parser.add_argument('--modeltype', type=str,default = 's1')
...
def train_one_epoch(epoch, train_loader, model, criterion, cfg, optimizer):
    ...
    if epoch >= cfg['warmup_epoch']:
        criterion.cfg['warmup_end'] = True
    else:
        criterion.cfg['warmup_end'] = False
